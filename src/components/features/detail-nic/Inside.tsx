...
export default function Inside() {
  return (
    ...
    >
      ...
      >
        {/* GDG Cityscape Image (behind the mask) */}
        ...
        <div className="relative" style={{ zIndex: 2 }}>
          ...
          {/* Small overlap block to prevent subpixel gaps on mobile without affecting Journey section */}

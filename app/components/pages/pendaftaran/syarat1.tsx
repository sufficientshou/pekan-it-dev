...
const folders: Folder[] = [
  ...
  },
  {
    ...
    bgColor: "#3f78ff",
    lightBg: "#6f9cff",
    icon: "/images/ri_instagram-fill (1).svg",
  },
  {
    id: "twibbon",
    ...
    bgColor: "#6d63ff",
    lightBg: "#9a93ff",
    icon: "/images/fluent_image-sparkle-20-filled.svg",
  },
  {
    id: "share-ig",
...
function SyaratCard({
  ...
  return (
    <div className="relative max-md:!w-[82vw] max-md:!max-w-[300px] max-md:!h-[210px] max-md:!shrink-0 max-md:!snap-center max-md:active:scale-[0.98] transition-all" style={{ width: "360px", height: "260px" }}>
